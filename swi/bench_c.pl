:- use_module(c_driven, [init/0, prepare_c_int/7, run_c_int/6, ast_to_bc_file/3, linear_bytecode/7]).
...
run_prepared(Benchmark) :-
    ...
    c_driven:list_to_char_ptr(ResBCEnv, CE),
    c_driven:list_to_char_ptr(ResBC, CBC),
